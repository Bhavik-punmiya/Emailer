-- Complete fix for email_campaigns table - add ALL missing columns
...
WHERE failed_count IS NULL OR total_recipients IS NULL OR progress IS NULL OR sent_count IS NULL;
